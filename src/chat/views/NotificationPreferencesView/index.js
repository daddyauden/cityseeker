...
const SectionSeparator = React.memo(() => (
    <View style={[Style.bg_color_14, {height: 10}]} />
));

const Info = React.memo(({info}) => (
    <Text
        style={[
            Style.f_size_12,
            Style.f_color_6,
...
const OPTIONS = {
    ...
    desktopNotificationDuration: [
        ...
        {
            label: I18n.t('Seconds', {second: 1}),
            value: 1,
        },
        {
            label: I18n.t('Seconds', {second: 2}),
            value: 2,
        },
        {
            label: I18n.t('Seconds', {second: 3}),
            value: 3,
        },
        {
            label: I18n.t('Seconds', {second: 4}),
            value: 4,
        },
        {
            label: I18n.t('Seconds', {second: 5}),
            value: 5,
        },
    ],
...
export default class NotificationPreferencesView extends React.Component {
    ...
    renderSwitch = key => {
        ...
        return (
            <Switch
                ...
                testID={key}
                trackColor={{
                    false: Style.bg_color_14.backgroundColor,
                    true: Style.bg_color_green.backgroundColor,
                }}
    ...
    render() {
        ...
        return (
            <SafeAreaView
                style={[Style.flex, Style.bg_color_gray]}
                testID="notification-preference-view"
                forceInset={{vertical: 'never'}}>
                <StatusBar />
                <ScrollView
                    {...scrollPersistTaps}
                    contentContainerStyle={[Style.bg_color_15]}
                    ...
                    <Separator />
                    <Info
                        info={I18n.t('Receive_notifications_from', {
                            name: room.name,
                        })}
                    />
                    <SectionSeparator />
