...
class ThreadMessagesView extends React.Component {
    ...
    subscribeData = () => {
        try {
            ...
            this.subSubscription = this.subObservable.subscribe(data => {
                this.subscription = data;
            });
            this.messagesObservable = db.collections
                .get('threads')
                .query(Q.where('rid', this.rid), Q.where('t', Q.notEq('rm')))
    ...
    updateThreads = async ({update, remove, lastThreadSync}) => {
        try {
            ...
            if (update && update.length) {
                ...
                threadsToUpdate = allThreadsRecords.filter(i1 =>
        ...
        return (
            <SafeAreaView
                ...
                <FlatList
                    ...
                    ListFooterComponent={
                        loading ? <RCActivityIndicator /> : null
                    }
                />
            </SafeAreaView>
        );
