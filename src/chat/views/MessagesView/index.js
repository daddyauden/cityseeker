...
class MessagesView extends React.Component {
    ...
    constructor(props) {
        ...
        this.content = this.defineMessagesViewContent(
    ...
    shouldComponentUpdate(nextProps, nextState) {
        const {loading, messages, photoModalVisible, fileLoading} = this.state;
    ...
    defineMessagesViewContent = name => {
        ...
        return {
            ...
            Files: {
                name: I18n.t('Files'),
                fetchFunc: async () => {
                    const result = await RocketChat.getFiles(
                        this.rid,
                        this.t,
                        messages.length,
                    );
            ...
            Mentions: {
                ...
                renderItem: item => (
                    <Message {...renderItemCommonProps(item)} msg={item.msg} />
                ),
            },
            ...
            Starred: {
                ...
                handleActionPress: message =>
                    RocketChat.toggleStarMessage(message._id, message.starred),
            },
            ...
            Pinned: {
                ...
                handleActionPress: message =>
                    RocketChat.togglePinMessage(message._id, message.pinned),
            },
        }[name];
    };
    ...
    handleActionPress = async actionIndex => {
        if (actionIndex === ACTION_INDEX) {
            ...
            try {
                ...
                console.warn(
                    'MessagesView -> handleActionPress -> catch -> error',
                    error,
                );
            }
        }
