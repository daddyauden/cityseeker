...
class RoomInfoEditView extends React.Component {
            ...
            if (error) {
                showErrorAlert(
                    I18n.t('There_was_an_error_while_action', {
                        action: I18n.t('saving_settings'),
                    }),
                );
            } else {
                EventEmitter.emit(LISTENER, {
                    message: I18n.t('Settings_succesfully_changed'),
                });
            }
        }, 100);
    };
    ...
    toggleArchive = () => {
        ...
        Alert.alert(
            I18n.t('Are_you_sure_question_mark'),
            I18n.t('Do_you_really_want_to_key_this_room_question_mark', {
                key: action,
            }),
            [
                {
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            await RocketChat.toggleArchiveRoom(
                                rid,
                                t,
                                !archived,
                            );
    ...
    hasDeletePermission = () => {
        ...
        return room.t === 'p'
            ? permissions[PERMISSION_DELETE_P]
            : permissions[PERMISSION_DELETE_C];
    };

    hasArchivePermission = () => {
        const {permissions} = this.state;
        return (
            permissions[PERMISSION_ARCHIVE] || permissions[PERMISSION_UNARCHIVE]
        );
    };
                ...
                <ScrollView
                    ...
                    <SafeAreaView
                        ...
                        <SwitchContainer
                            ...
                            disabled={
                                !permissions[PERMISSION_SET_READONLY] ||
                                room.broadcast
                            }
                        ...
                        <View style={{flexDirection: 'row'}}>
                            ...
                            <TouchableOpacity
                                style={[
                                    sharedStyles.buttonContainer_inverted,
                                    styles.buttonDanger,
                                    !this.hasArchivePermission() &&
                                        sharedStyles.opacity5,
