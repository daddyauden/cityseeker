...
class Sidebar extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            nextProps.user &&
            user &&
            user.language !== nextProps.user.language
        ) {
            this.setStatus();
        }
        ...
        try {
            if (roles) {
                ...
                const isAdmin = permissionsFiltered.reduce(
                    (result, permission) =>
                        result ||
                        permission.roles.some(r => roles.indexOf(r) !== -1),
                    false,
                );
    ...
    renderStatusItem = ({item}) => {
        ...
        return (
            <SidebarItem
                text={item.name}
                left={
                    <Status style={styles.status} size={12} status={item.id} />
                }
        ...
        return (
            <>
                ...
                <SidebarItem
                    text={I18n.t('Profile')}
                    left={
                        <CustomIcon name="user" size={20} color={COLOR_TEXT} />
                    }
                ...
                <SidebarItem
                    ...
                    left={
                        <CustomIcon name="cog" size={20} color={COLOR_TEXT} />
                    }
                ...
                <ScrollView style={styles.container} {...scrollPersistTaps}>
                    <RectButton
                        ...
                        <View style={styles.headerTextContainer}>
                            ...
                            <Text
                                style={styles.currentServerText}
                                numberOfLines={1}>
                                {Site_Name}
                            </Text>
                        </View>
