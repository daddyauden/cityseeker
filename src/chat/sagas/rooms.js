import {put, select, race, take, fork, cancel, delay} from 'redux-saga/effects';
...
const handleRoomsRequest = function* handleRoomsRequest() {
    try {
        ...
        yield db.action(async () => {
            ...
            const existingSubs = await subCollection
                .query(Q.where('id', Q.oneOf(subsIds)))
                .fetch();
            const subsToUpdate = existingSubs.filter(i1 =>
                subscriptions.find(i2 => i1._id === i2._id),
            );
