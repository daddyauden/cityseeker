...
class EmojiPicker extends Component {
    ...
    _addFrequentlyUsed = protectedFunction(async emoji => {
        ...
        const freqEmojiCollection = db.collections.get(
    ...
    updateFrequentlyUsed = async () => {
        const db = database.active;
        const frequentlyUsedRecords = await db.collections
            .get('frequently_used_emojis')
            .query()
            .fetch();
        let frequentlyUsed = orderBy(
            frequentlyUsedRecords,
            ['count'],
            ['desc'],
        );
