export default {
    ...
    'error-archived-duplicate-name':
        'Есть архивный канал с именем {{room_name}}',
    'error-avatar-invalid-url': 'Недопустимый URL-адрес аватара: {{url}}',
    'error-avatar-url-handling':
        'Ошибка при обработке настроек аватара с URL-адреса ({{url}}) для {{username}}',
    'error-cant-invite-for-direct-room':
        'Невозможно пригласить пользователя в личную переписку',
    ...
    'error-direct-message-file-upload-not-allowed':
        'Общий доступ к файлам не разрешен в личных сообщениях',
    'error-duplicate-channel-name':
        'Канал с именем {{channel_name}} существует',
    'error-email-domain-blacklisted':
        'Домен электронной почты включен в черный список',
    'error-email-send-failed':
        'Ошибка при попытке отправить электронное письмо: {{message}}',
    'error-field-unavailable': '{{field}} уже используется :(',
    'error-file-too-large': 'Файл слишком большой',
    'error-importer-not-defined':
        'Импортер не был определен правильно, ему не хватает класса Import.',
    ...
    'error-invalid-channel-start-with-chars':
        'Недействительный канал. Начните с @ или #',
    'error-invalid-custom-field': 'Неверное настраиваемое поле',
    'error-invalid-custom-field-name':
        'Неверное имя настраиваемого поля. Используйте только буквы, цифры, дефисы и символы подчеркивания.',
    ...
    'error-invalid-room-name':
        '{{room_name}} не является допустимым именем канала',
    ...
    'error-invalid-webhook-response':
        'URL-адрес ответил статусом, отличным от 200',
    ...
    'error-message-size-exceeded':
        'Размер сообщения превышает Message_MaxAllowedSize',
    ...
    'error-remove-last-owner':
        'Это последний владелец. Прежде чем удалить его, установите нового владельца.',
    ...
    'error-too-many-requests':
        'Ошибка, слишком много запросов. Пожалуйста, помедленнее. Вы должны подождать {{seconds}} секунд, прежде чем повторить попытку.',
    'error-user-is-not-activated': 'Пользователь не активирован',
    'error-user-has-no-roles': 'Пользователь не имеет ролей',
    'error-user-limit-exceeded':
        'Количество пользователей, которых вы пытаетесь пригласить на #channel_name, превышает лимит, установленный администратором',
    ...
    'error-user-registration-secret':
        'Регистрация пользователей разрешена только через секретный URL',
    'error-you-are-last-owner':
        'Вы последний владелец. Пожалуйста, установите нового владельца, прежде чем покинуть комнату.',
    Actions: 'Действия',
    activity: 'активность',
    Activity: 'Активность',
    ...
    All_users_in_the_channel_can_write_new_messages:
        'Все пользователи канала могут писать новые сообщения',
    All: 'Все',
    ...
    Are_you_sure_you_want_to_leave_the_room:
        'Вы действительно хотите покинуть канал {{room}}?',
    Audio: 'Аудио',
    ...
    Broadcast_channel_Description:
        'Только авторизованные пользователи могут писать новые сообщения, но другие пользователи смогут ответить',
    ...
    Whats_the_password_for_your_certificate:
        'Какой пароль для вашего сертификата?',
    ...
    Delete_Room_Warning:
        'Удаление канала приведет к удалению всех сообщений, размещенных в нем. Это не может быть отменено.',
    delete: 'удалить',
    Delete: 'Удалить',
    DELETE: 'УДАЛИТЬ',
    ...
    For_your_security_you_must_enter_your_current_password_to_continue:
        'В целях вашей безопасности вы должны ввести свой текущий пароль для продолжения',
    Forgot_my_password: 'Забыл свой пароль',
    Forgot_password_If_this_email_is_registered:
        'Если эта электронная почта зарегистрирована, мы отправим инструкции о том, как сбросить пароль. Если вы не получите письмо в ближайшее время, вернитесь и повторите попытку.',
    ...
    In_App_and_Desktop_Alert_info:
        'Отображает баннер в верхней части экрана, когда приложение открыто, и отображает уведомление на рабочем столе.',
    Invisible: 'Невидимый',
    Invite: 'Приглашение',
    is_a_valid_RocketChat_instance:
        'является действительным сервером Rocket.Chat',
    is_not_a_valid_RocketChat_instance:
        'не является действительным сервером Rocket.Chat',
    is_typing: 'печатает',
    ...
    Just_invited_people_can_access_this_channel:
        'Только приглашенные люди могут получить доступ к этому каналу',
    Language: 'Язык',
    ...
    Login: 'Вход',
    Login_error:
        'Ваши учетные данные были отклонены! Пожалуйста, попробуйте еще раз.',
    Login_with: 'Войти с',
    Logout: 'Выйти',
    ...
    Microphone_Permission_Message:
        'Rocket Chat нужен доступ к вашему микрофону, чтобы вы могли отправлять аудиосообщения.',
    ...
    Notify_active_in_this_room:
        'Уведомить всех активных пользователей в этом чате',
    ...
    Only_authorized_users_can_write_new_messages:
        'Только авторизованные пользователи могут писать новые сообщения',
    Open_emoji_selector: 'Открыть селектор emoji',
    Open_Source_Communication: 'Общение с открытым кодом',
    Password: 'Пароль',
    Permalink_copied_to_clipboard:
        'Постоянная ссылка скопирована в буфер обмена!',
    ...
    Push_Notifications_Alert_Info:
        'Эти уведомления доставляются вам, когда приложение не открыто',
    Quote: 'Цитата',
    ...
    Room_changed_announcement:
        'Объявление канала было изменено на: {{объявление}} пользователем {{userBy}}',
    Room_changed_description:
        'Описание комнаты было изменено на: {{объявление}} пользователем {{userBy}}',
    Room_changed_privacy:
        'Тип канала был изменен на: {{type}} пользователем {{userBy}}',
    Room_changed_topic:
        'Топик канала был изменен на: {{topic}} пользователем {{userBy}}',
    Room_Files: 'Файлы',
    Room_Info_Edit: 'Редактировать информацию о канале',
    Room_Info: 'Информация о канале',
    Room_Members: 'Пользователи',
    Room_name_changed:
        'Название канала было изменено на: {{name}} пользователем {{userBy}}',
    SAVE: 'СОХРАНИТЬ',
    ...
    Search_global_users_description:
        'При активации станет возможен поиск пользователей на других серверах.',
    ...
    Set_username_subtitle:
        'Имя пользователя необходимо для того, чтобы позволить другим упомянуть вас в сообщениях',
    Settings: 'Настройки',
    ...
    Show_Unread_Counter_Info:
        'Счетчик непрочитанных отображается в виде значка справа от канала в списке каналов',
    ...
    Theme: 'Тема',
    The_URL_is_invalid:
        'IНеверный URL или невозможно установить безопасное соединение.\n{{contact}}',
    ...
    User_is_no_longer_role_by_:
        '{{user}} больше не {{role}} по решению {{userBy}}',
    User_muted_by: 'Пользователь {{userMuted}} заглушен по решению {{userBy}}',
    User_removed_by:
        'Пользователь {{userRemoved}} удален по решению {{userBy}}',
    User_sent_an_attachment: '{{user}} отправил вложение',
    User_unmuted_by:
        'Пользователь {{userUnmuted}} перестал быть заглушенным по решению {{userBy}}',
    User_was_set_role_by_:
        '{{user}} был назначен {{role}} пользователем {{userBy}}',
    ...
    You_can_search_using_RegExp_eg:
        'Вы можете выполнить поиск с помощью регулярных выражений, например `/^text$/i`',
    You_colon: 'Вы: ',
    you_were_mentioned: 'вы были упомянуты',
    you: 'вы',
    You: 'Вы',
    You_need_to_access_at_least_one_RocketChat_server_to_share_something:
        'Вам нужно получить доступ как минимум к одному серверу Rocket.Chat, чтобы поделиться чем-то.',
    Your_certificate: 'Ваш сертификат',
    Version_no: 'Version: {{version}}',
    You_will_not_be_able_to_recover_this_message:
        'Вы не сможете восстановить это сообщение!',
    Change_Language: 'Изменить язык',
    Crash_report_disclaimer:
        'Мы никогда не отслеживаем содержание ваших чатов. Отчет о сбое содержит только важную для нас информацию для выявления проблем и их устранения.',
};
