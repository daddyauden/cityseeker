export default {
    ...
    'error-avatar-url-handling':
        '将 {{username}} 的头像设置为URL({{url}})时发送了错误',
    ...
    'error-invalid-custom-field-name':
        '无效的自定义字段名. 只能包含 字母, 数字, 中线(-) and 下划线(_).',
    ...
    For_your_security_you_must_enter_your_current_password_to_continue:
        '为了安全起见，您必须输入当前密码才能继续',
    Forgot_my_password: '忘记密码',
    Forgot_password_If_this_email_is_registered:
        '如果这封邮件已注册，我们将发送如何重置密码的说明。如果您没有立即收到电子邮件，请回来再试一次。',
    ...
    Microphone_Permission_Message:
        'Rocket Chat需要访问您的麦克风，以便您可以发送音频消息。',
