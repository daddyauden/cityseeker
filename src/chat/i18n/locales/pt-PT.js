export default {
    ...
    'error-archived-duplicate-name':
        'Existe um canal arquivado com o nome {{room_name}}',
    'error-avatar-invalid-url': 'URL de avatar inválido: {{url}}',
    'error-avatar-url-handling':
        'Erro ao manipular a configuração de avatar de um URL ({{url}}) para {{username}}',
    'error-cant-invite-for-direct-room':
        'Não pode convidar utilizadores para salas de mensagens directas',
    ...
    'error-could-not-change-username':
        'Não foi possível alterar o nome de utilizador',
    'error-delete-protected-role':
        'Não é possível eliminar uma função protegida',
    'error-department-not-found': 'Departamento não encontrado',
    'error-direct-message-file-upload-not-allowed':
        'Partilha de ficheiros não permitido em mensagens diretas',
    'error-duplicate-channel-name':
        'Um canal com o nome {{channel_name}} existe',
    ...
    'error-importer-not-defined':
        'O importador não foi definido correctamente, a classe Import está em falta.',
    ...
    'error-invalid-channel-start-with-chars':
        'Canal inválido. Começa por @ ou #',
    'error-invalid-custom-field': 'Campo personalizado inválido',
    'error-invalid-custom-field-name':
        'Nome de campo personalizado inválido. Use apenas letras, números, hífens e sublinhados.',
    ...
    'error-invalid-webhook-response':
        'O URL do webhook respondeu com um estado diferente de 200',
    ...
    'error-missing-unsubscribe-link':
        'Você deve fornecer o link para cancelar a subscrição: [unsubscribe].',
    ...
    'error-too-many-requests':
        'Erro, demasiados pedidos. Por favor, diminua a velocidade. Você deve esperar {{seconds}} segundos antes de tentar novamente.',
    'error-user-is-not-activated': 'O utilizador não está activado',
    'error-user-has-no-roles': 'O utilizador não tem funções',
    'error-user-limit-exceeded':
        'O número de utilizadores que você está a tentar convidar para #channel_name excede o limite definido pelo administrador',
    ...
    'error-user-registration-disabled':
        'O registo de utilizadores está desactivado',
    'error-user-registration-secret':
        'O registo de utilizadores só é permitido por meio de um URL secreto',
    'error-you-are-last-owner':
        'Você é o último proprietário. Por favor, defina novo proprietário antes de sair da sala.',
    Actions: 'Acções',
    activity: 'actividade',
    Activity: 'Actividade',
    ...
    All_users_in_the_channel_can_write_new_messages:
        'Todos os utilizadores no canal podem escrever novas mensagens',
    All: 'Todos',
    ...
    Are_you_sure_you_want_to_leave_the_room:
        'Tem certeza de que quer sair da sala {{room}}?',
    ...
    Broadcast_channel_Description:
        'Apenas utilizadores autorizados podem escrever novas mensagens, mas os outros utilizadores poderão responder',
    Broadcast_Channel: 'Canal de Transmissão',
    Busy: 'Ocupado',
    By_proceeding_you_are_agreeing:
        'Ao prosseguir você concorda com o(s) nosso(s)',
    ...
    Create: 'Criar',
    Delete_Room_Warning:
        'Apagar uma sala irá remover todas as mensagens contidas nela. Isto não pode ser desfeito.',
    delete: 'apagar',
    Delete: 'Apagar',
    DELETE: 'APAGAR',
    ...
    Do_you_really_want_to_key_this_room_question_mark:
        'Você quer mesmo {{key}} esta sala?',
    edit: 'editar',
    erasing_room: 'apagando sala',
    Edit: 'Editar',
    Email_or_password_field_is_empty:
        'O campo de e-mail ou palavra-passe está vazio',
    Email: 'E-mail',
    email: 'e-mail',
    ...
    Forgot_password_If_this_email_is_registered:
        'Se este e-mail estiver registado, enviaremos instruções sobre como repor a sua palavra-passe. Se você não receber um e-mail em breve, volte e tente novamente.',
    ...
    Invalid_server_version:
        'O servidor ao qual esta tentando ligar-se, utiliza uma versão que não é suporta pela aplicação: {{currentVersion}}.\n\nA versão mínima requerida é {{minVersion}}',
    Join_the_community: 'Junte-se à comunidade',
    Join: 'Entrar',
    Just_invited_people_can_access_this_channel:
        'Apenas utilizadores convidados podem aceder a este canal',
    Language: 'Idioma',
    ...
    Login: 'Entrar',
    Login_error:
        'As suas credenciais foram rejeitadas! Por favor, tente novamente.',
    ...
    Microphone_Permission_Message:
        'O Rocket Chat necessita de acesso ao seu microfone para que você possa enviar mensagens de áudio.',
    ...
    Only_authorized_users_can_write_new_messages:
        'Apenas utilizadores autorizados podem escrever novas mensagens',
    ...
    Room_changed_announcement:
        'Anúncio da sala alterado para: {{announcement}} por {{userBy}}',
    Room_changed_description:
        'Descrição da sala alterada para: {{description}} por {{userBy}}',
    Room_changed_privacy: 'Tipo de sala alterado para: {{type}} por {{userBy}}',
    Room_changed_topic:
        'Tópico da sala alterado para: {{topic}} por {{userBy}}',
    ...
    Set_username_subtitle:
        'O nome de utilizador é usado para permitir que outros mencionem você em mensagens',
    Settings: 'Definições',
    ...
    The_URL_is_invalid:
        'O URL que você inseriu é inválido. Verifique e tente novamente, por favor!',
    ...
    User_is_no_longer_role_by_:
        '{{userBy}} removeu o estatuto de {{role}} de {{user}}',
    ...
    You_can_search_using_RegExp_eg:
        'Você pode pesquisar usando RegEx. por exemplo, `/^text$/i`',
    You_colon: 'Você: ',
    you_were_mentioned: 'você foi mencionado',
    you: 'você',
    You: 'Você',
    You_will_not_be_able_to_recover_this_message:
        'Você será incapaz de recuperar esta mensagem!',
};
