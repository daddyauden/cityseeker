export default {
    ...
    'error-archived-duplicate-name':
        'Il y a un canal archivé avec nom {{room_name}}',
    'error-avatar-invalid-url': "URL d'avatar invalide: {{url}}",
    'error-avatar-url-handling':
        "Erreur lors de la gestion du paramètre d'avatar à partir d'une URL ({{url}}) pour {{username}}",
    'error-cant-invite-for-direct-room':
        "Impossible d'inviter l'utilisateur aux salles direct",
    ...
    'error-could-not-change-username':
        "Impossible de changer le nom d'utilisateur",
    ...
    'error-direct-message-file-upload-not-allowed':
        "Le partage de fichiers n'est pas autorisé dans les messages directs",
    'error-duplicate-channel-name': 'un canal avec nom {{channel_name}} existe',
    'error-email-domain-blacklisted':
        'Le domaine de messagerie est sur liste noire',
    'error-email-send-failed':
        "Erreur lors de la tentative d'envoi d'un courrier électronique: {{message}}",
    ...
    'error-importer-not-defined':
        "L'importateur n'a pas été défini correctement, il manque la classe import.",
    ...
    'error-invalid-channel-start-with-chars':
        'Canal invalide. Commence par @ ou #',
    'error-invalid-custom-field': 'Champ personnalisé incorrect',
    'error-invalid-custom-field-name':
        "Nom de champ personnalisé non valide. Utilisez uniquement des lettres, des chiffres, des traits d'union et de soulignement.",
    ...
    'error-invalid-from-address':
        'Vous avez informé une adresse FROM invalide.',
    ...
    'error-invalid-webhook-response':
        "L'URL webhook a répondu avec un statut autre que 200",
    ...
    'error-message-size-exceeded':
        'La taille du message dépasse Message_MaxAllowedSize',
    'error-missing-unsubscribe-link':
        'Vous devez fournir le [unsubscribe] lien.',
    'error-no-tokens-for-this-user':
        "Il n'y a pas de jetons pour cet utilisateur",
    ...
    'error-remove-last-owner':
        'Ceci est le dernier propriétaire. Veuillez définir un nouveau propriétaire avant de supprimer celui-ci.',
    ...
    'error-too-many-requests':
        "Erreur, trop de demandes. Ralentissez, s'il vous plaît. Vous devez attendre {{seconds}} secondes avant d'essayer à nouveau.",
    ...
    'error-user-limit-exceeded':
        "Le nombre d'utilisateurs que vous essayez d'inviter à #channel_name dépasse la limite définie par l'administrateur",
    ...
    'error-user-registration-disabled':
        "L'enregistrement de l'utilisateur est désactivé",
    'error-user-registration-secret':
        "Enregistrement de l'utilisateur est autorisée uniquement via l'URL secret",
    'error-you-are-last-owner':
        'Vous êtes le dernier propriétaire. Veuillez définir un nouveau propriétaire avant de quitter la salle.',
    Actions: 'Actions',
    activity: 'activité',
    Activity: 'Activité',
    ...
    All_users_in_the_channel_can_write_new_messages:
        'Tous les utilisateurs du canal peuvent écrire de nouveaux messages',
    All: 'Tout',
    ...
    Are_you_sure_you_want_to_leave_the_room:
        'Êtes-vous sûr de vouloir quitter le salon {{room}}?',
    ...
    Broadcast_channel_Description:
        'Seuls les utilisateurs autorisés peuvent écrire de nouveaux messages, mais les autres utilisateurs pourront répondre.',
    ...
    Create: 'Créer',
    Delete_Room_Warning:
        'Supprimer une salle supprimera tous les messages postés dans la salle. Ça ne peut pas être annulé.',
    delete: 'supprimez',
    Delete: 'Supprimez',
    DELETE: 'SUPPRIMEZ',
    ...
    Do_you_really_want_to_key_this_room_question_mark:
        'Voulez-vous vraiment {{key}} cette salle?',
    edit: 'modifier',
    erasing_room: 'effacement de la salle',
    Edit: 'Modifier',
    Email_or_password_field_is_empty:
        'Le champ e-mail ou mot de passe est vide',
    Email: 'E-mail',
    email: 'e-mail',
    ...
    Forgot_password_If_this_email_is_registered:
        "Si cet e-mail est enregistré, nous vous enverrons des instructions pour réinitialiser votre mot de passe. Si vous ne recevez pas d'e-mail sous peu, veuillez revenir et réessayer.",
    ...
    is_not_a_valid_RocketChat_instance:
        "n'est pas une instance valide de Rocket.Chat",
    is_typing: "est en train d'écrire",
    Invalid_server_version:
        "Le serveur que vous essayez de connecter utilise une version qui n'est plus prise en charge par l'application: {{currentVersion}}.\n\nNous exigeons la version {{minVersion}}",
    Join_the_community: 'Rejoindre la communauté',
    Join: 'Rejoindre',
    Just_invited_people_can_access_this_channel:
        'Seuls les invités peuvent accéder à ce canal',
    Language: 'Langue',
    ...
    Microphone_Permission_Message:
        'Rocket Chat doit avoir accès à votre microphone pour pouvoir envoyer un message audio.',
    ...
    Notify_active_in_this_room:
        'Notifier les utilisateurs actifs dans cette salle',
    Notify_all_in_this_room: 'Notifier tous dans cette salle',
    Offline: 'Hors ligne',
    Oops: 'Oops!',
    Online: 'En ligne',
    Only_authorized_users_can_write_new_messages:
        'Seuls les utilisateurs autorisés peuvent écrire de nouveaux messages.',
    ...
    Permalink_copied_to_clipboard:
        'Lien permanent copié dans le presse-papier!',
    Pin: 'Épingler',
    ...
    Room_changed_announcement:
        'Annonce de canal est changée en: {{announcement}} par {{userBy}}',
    Room_changed_description:
        'Description de canal est changée en: {{description}} par {{userBy}}',
    Room_changed_privacy:
        'Type de canal est changé en: {{type}} par {{userBy}}',
    Room_changed_topic:
        'Le sujet de canal est changé en: {{topic}} par {{userBy}}',
    ...
    Set_username_subtitle:
        "Le nom d'utilisateur est utilisé pour permettre aux autres de vous mentionner dans les messages",
    Settings: 'Paramètres',
    ...
    The_URL_is_invalid:
        "L'URL que vous avez entrée n'est pas valide. Vérifiez et essayez à nouveau!",
    ...
    User_muted_by:
        "L'utilisateur {{userMuted}} a été rendu muet par {{userBy}}",
    User_removed_by:
        "L'utilisateur {{userRemoved}} a été  retiré par {{userBy}}",
    User_sent_an_attachment: '{{user}} envoyé une pièce jointe',
    User_unmuted_by:
        "L'utilisateur {{userBy}} a rendu la parole a {{userUnmuted}} ",
    User_was_set_role_by_:
        "{{user}} l'utilisateur a été défini {{role}} par {{userBy}}",
    ...
    You_can_search_using_RegExp_eg:
        "Vous pouvez rechercher à l'aide de RegExp. e.g. `/^text$/i`",
    You_colon: 'Vous: ',
    you_were_mentioned: 'vous avez été mentionné',
    you: 'vous',
    You: 'Vous',
    You_will_not_be_able_to_recover_this_message:
        'Vous ne serez pas en mesure de récupérer ce message!',
};
