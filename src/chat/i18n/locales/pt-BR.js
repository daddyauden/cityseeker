export default {
    ...
    'error-archived-duplicate-name':
        'Já há um canal arquivado com o nome {{room_name}}',
    'error-avatar-invalid-url': 'URL inválida de avatar: {{url}}',
    'error-avatar-url-handling':
        'Erro durante o manuseio configuração avatar a partir de uma URL ({{url}}) para {{username}}',
    'error-cant-invite-for-direct-room':
        'Não é possível convidar usuários para salas diretas',
    ...
    'error-direct-message-file-upload-not-allowed':
        'Compartilhamento de arquivos não está permitido em mensagens diretas',
    'error-duplicate-channel-name':
        'Já existe um canal com nome {{channel_name}}',
    ...
    'error-importer-not-defined':
        'O importador não foi definido corretamente;  está faltando a classe Import.',
    ...
    'error-invalid-channel-start-with-chars':
        'Canal inválido. Comece com @ ou #',
    'error-invalid-custom-field': 'Campo personalizado inválido',
    'error-invalid-custom-field-name':
        'Nome inválido para o campo personalizado. Use apenas letras, números, hífens e underscores.',
    ...
    'error-invalid-webhook-response':
        'O URL do webhook respondeu com um status diferente de 200',
    ...
    'error-message-size-exceeded':
        'O tamanho da mensagem excede Message_MaxAllowedSize',
    'error-missing-unsubscribe-link':
        'Você deve fornecer o link para desinscrever-se: [unsubscribe].',
    ...
    'error-password-policy-not-met':
        'A senha não atende a política do servidor',
    'error-password-policy-not-met-maxLength':
        'A senha não está de acordo com a política de comprimento máximo do servidor  (senha muito longa)',
    'error-password-policy-not-met-minLength':
        'A senha não está de acordo com a política de comprimento mínimo do servidor  (senha muito curta)',
    'error-password-policy-not-met-oneLowercase':
        'A senha não está de acordo com a política do servidor de pelo menos um caractere minúsculo.',
    'error-password-policy-not-met-oneNumber':
        'A senha não está de acordo com a política do servidor, de pelo menos um caractere numérico.',
    'error-password-policy-not-met-oneSpecial':
        'A senha não está de acordo com a política do servidor, de pelo menos um caractere especial.',
    'error-password-policy-not-met-oneUppercase':
        'A senha não está de acordo com a política do servidor, de pelo menos um caractere maiúsculo.',
    'error-password-policy-not-met-repeatingCharacters':
        'A senha não está de acordo com a política do servidor, relativamente aos caracteres proibidos repetidos (existem vários caracteres proibidos próximos uns dos outros)',
    'error-push-disabled': 'Notificações push desativadas',
    'error-remove-last-owner':
        'Este é o último proprietário. Por favor, defina um novo proprietário antes de remover este.',
    ...
    'error-too-many-requests':
        'Erro, muitas solicitações. Por favor, diminua a velocidade. Você deve esperar {{seconds}} segundos antes de tentar novamente.',
    'error-user-has-no-roles': 'O usuário não possui permissões',
    'error-user-is-not-activated': 'O usuário não está ativo',
    'error-user-limit-exceeded':
        'O número de usuários que você está tentando convidar para #channel_name excede o limite determindado pelo administrador',
    ...
    'error-user-registration-secret':
        'O registro de usuário é permitido somente via URL secreta',
    'error-you-are-last-owner':
        'Você é o último proprietário da sala. Por favor defina um novo proprietário antes de sair.',
    Actions: 'Ações',
    activity: 'atividade',
    Activity: 'Atividade',
    Add_Reaction: 'Reagir',
    ...
    All_users_in_the_channel_can_write_new_messages:
        'Todos usuários no canal podem enviar mensagens novas',
    All: 'Todos',
    ...
    Are_you_sure_you_want_to_leave_the_room:
        'Tem certeza de que deseja sair da sala {{room}}?',
    ...
    Broadcast_channel_Description:
        'Somente usuários autorizados podem escrever novas mensagens, mas os outros usuários poderão responder',
    ...
    Create: 'Criar',
    Delete_Room_Warning:
        'A exclusão de uma sala irá apagar todas as mensagens postadas na sala. Isso não pode ser desfeito.',
    delete: 'excluir',
    Delete: 'Excluir',
    DELETE: 'EXCLUIR',
    ...
    Do_you_really_want_to_key_this_room_question_mark:
        'Você quer realmente {{key}} esta sala?',
    edit: 'editar',
    edited: 'editado',
    ...
    For_your_security_you_must_enter_your_current_password_to_continue:
        'Para sua segurança, você precisa digitar sua senha',
    Forgot_my_password: 'Esqueci minha senha',
    Forgot_password_If_this_email_is_registered:
        'Se este e-mail estiver cadastrado, enviaremos instruções sobre como redefinir sua senha. Se você não receber um e-mail em breve, volte e tente novamente.',
    ...
    Just_invited_people_can_access_this_channel:
        'Apenas as pessoas convidadas podem acessar este canal',
    Language: 'Idioma',
    ...
    Login: 'Entrar',
    Login_error:
        'Suas credenciais foram rejeitadas. Tente novamente por favor!',
    ...
    Microphone_Permission_Message:
        'Rocket Chat precisa de acesso ao seu microfone para enviar mensagens de áudio.',
    ...
    Room_changed_description:
        'A descrição da sala foi alterada para: {{description}} por {{userBy}}',
    ...
    Search_global_users_description:
        'Caso ativado, busca por usuários de outras empresas ou servidores.',
    ...
    Set_username_subtitle:
        'O usuário é utilizado para permitir que você seja mencionado em mensagens',
    ...
    The_URL_is_invalid:
        'A URL fornecida é inválida ou incapaz de estabelecer uma conexão segura.\n{{contact}}',
    ...
    User_is_no_longer_role_by_:
        '{{user}} não pertence mais à {{role}} por {{userBy}}',
    ...
    Websocket_disabled:
        'Websocket está desativado para esse servidor.\n{{contact}}',
    Welcome: 'Bem vindo',
    ...
    You_can_search_using_RegExp_eg:
        'Você pode usar expressões regulares, por exemplo `/^text$/i`',
    You_colon: 'Você: ',
    you_were_mentioned: 'você foi mencionado',
    you: 'você',
    You: 'Você',
    You_need_to_access_at_least_one_RocketChat_server_to_share_something:
        'Você precisa acessar ao menos um servidor Rocket.Chat para compartilhar.',
    You_will_not_be_able_to_recover_this_message:
        'Você não será capaz de recuperar essa mensagem!',
};
