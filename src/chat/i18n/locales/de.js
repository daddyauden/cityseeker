export default {
    ...
    'error-invalid-channel-start-with-chars':
        'Ungültiger Kanal. Beginnen Sie mit @ oder #',
    'error-invalid-custom-field': 'Ungültiges benutzerdefiniertes Feld',
    'error-invalid-custom-field-name':
        'Ungültiger benutzerdefinierter Feldname. Verwenden Sie nur Buchstaben, Zahlen, Bindestriche und Unterstriche.',
    ...
    'error-invalid-from-address':
        'Sie haben eine ungültige FROM-Adresse mitgeteilt.',
    ...
    'error-message-deleting-blocked':
        'Das Löschen von Nachrichten ist gesperrt',
    ...
    'error-missing-unsubscribe-link':
        'Sie müssen den Link [abbestellen] angeben.',
    ...
    'error-remove-last-owner':
        'Dies ist der letzte Besitzer. Bitte legen Sie einen neuen Besitzer fest, bevor Sie diesen entfernen.',
    'error-role-in-use':
    ...
    'error-too-many-requests':
        'Fehler, zu viele Anfragen. Sie müssen {{Sekunden}} Sekunden warten, bevor Sie es erneut versuchen.',
    'error-user-is-not-activated': 'Benutzer ist nicht aktiviert',
    'error-user-has-no-roles': 'Benutzer hat keine Rollen',
    'error-user-limit-exceeded':
        'Die Anzahl der Benutzer, die Sie zu #channel_name einladen möchten, überschreitet die vom Administrator festgelegte Grenze',
    ...
    'error-you-are-last-owner':
        'Sie sind der letzte Besitzer. Bitte setzen Sie einen neuen Besitzer, bevor Sie den Raum verlassen.',
    Actions: 'Aktionen',
    activity: 'Aktivität',
    Activity: 'Aktivität',
    ...
    Are_you_sure_you_want_to_leave_the_room:
        'Möchten Sie den Raum wirklich verlassen {{room}}?',
    ...
    By_proceeding_you_are_agreeing:
        'Indem Sie fortfahren, stimmen Sie zu unserem',
    ...
    Do_you_really_want_to_key_this_room_question_mark:
        'Möchten Sie diesen Raum wirklich {{key}}?',
    edit: 'bearbeiten',
    edited: 'bearbeitet',
    Edit: 'Bearbeiten',
    ...
    For_your_security_you_must_enter_your_current_password_to_continue:
        'Zu Ihrer Sicherheit müssen Sie Ihr aktuelles Passwort eingeben, um fortzufahren',
    Forgot_my_password: 'Ich habe mein Passwort vergessen',
    Forgot_password_If_this_email_is_registered:
        'Wenn diese E-Mail registriert ist, senden wir Anweisungen zum Zurücksetzen Ihres Passworts. Wenn Sie in Kürze keine E-Mail erhalten, kommen Sie bitte zurück und versuchen Sie es erneut.',
    ...
    Invalid_server_version:
        'Der Server, zu dem Sie eine Verbindung herstellen möchten, verwendet eine Version, die von der App nicht mehr unterstützt wird: {{currentVersion}}.\n\nWir benötigen Version {{MinVersion}}.',
    ...
    Microphone_Permission_Message:
        'Rocket Chat benötigt Zugriff auf Ihr Mikrofon, damit Sie eine Audionachricht senden können.',
    ...
    Notify_active_in_this_room:
        'Aktive Benutzer in diesem Raum benachrichtigen',
    ...
    Search_global_users_description:
        'Beim Einschalten können Sie nach Benutzern von anderen Unternehmen oder Servern suchen.',
    ...
    Set_username_subtitle:
        'Der Benutzername wird verwendet, damit andere Personen Sie in Nachrichten erwähnen können',
    ...
    Theme: 'Theme',
    The_URL_is_invalid:
        'Die eingegebene URL ist ungültig. Überprüfen Sie es und versuchen Sie es erneut, bitte!',
    ...
    You_can_search_using_RegExp_eg:
        'Sie können mit RegExp suchen. z.B. `/ ^ text $ / i`',
    You_colon: 'Sie:',
    ...
    You_will_not_be_able_to_recover_this_message:
        'Sie können diese Nachricht nicht wiederherstellen!',
    Change_Language: 'Sprache ändern',
    Crash_report_disclaimer:
        'Wir verfolgen niemals den Inhalt Ihrer Chats. Der Crash-Report enthält nur für uns relevante Informationen in der Reihenfolge ',
};
