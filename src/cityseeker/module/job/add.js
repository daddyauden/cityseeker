...
class Default extends Component {
    static navigationOptions = ({navigation}) => {
        return {
            headerTitle: (
                <View style={[Style.h_center, Style.wrap]}>
                    <Text
                        style={[
                            Style.f_size_15,
                            Style.f_color_3,
    ...
    componentDidMount() {
        ...
        navigation.setParams({
            headerRight: (
                <TouchableWithoutFeedback>
                    <View style={[Style.p_r_3, Style.v_center]}>
                        <Text
                            style={[
                                Style.f_color_10,
                                Style.b,
